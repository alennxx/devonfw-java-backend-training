...
public interface UcFindOrder {
  ...
  /**
   * Returns list of Orders which have creationDate equal to given 'creationDate' and status equal to given 'status'
   *
   * @param creationDate
   * @param status
   * @return the {@link List} of Orders matching given parameters
   */
  List<OrderEto> findOrdersByCreationDateAndStatus(LocalDate creationDate, OrderStatus status);
